    ...
    function playThisSong(song, isPlaying = null) {
        ...
        if ("tags" in song) {
            ...
            if (catalog !== null) {
                ...
                if (song.tags.includes('touhou') || song.tags.includes('soundtrack') || song.tags.includes('doujin') || song.tags.includes('remix') || song.tags.includes('ed') || song.tags.includes('op')) {
