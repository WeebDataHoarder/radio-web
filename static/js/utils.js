...
function getCatalogNumberSearchLink(catalog, tags){
    ...
    let cleanCatalog = typeof catalog === 'string' ? catalog.replace(/-/g, "") : catalog;
    ...
    if (tags.includes('touhou')) {
        targetSearch = "https://thwiki.cc/index.php?setlang=en&search=" + encodeURIComponent("incategory:同人专辑 (\"" + catalog + "\""+(cleanCatalog ? "\"" + cleanCatalog + "\"" : "")+")");
